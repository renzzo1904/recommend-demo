...
class UI:
    ...
    def create_ui(self):
        "Constructing the UI"
        with gr.Blocks(css=css_path) as self.demo:
            with gr.Row():
            ...
            bt1.click(self.get_predictions, inputs=txt1, outputs=html1,queue=False).then(self.get_cluster,txt1,html2)
            bt2.click(self.get_predictions, inputs=txt2, outputs=html1,queue=False).then(self.get_cluster,txt2,html2)
            bt3.click(self.get_predictions, inputs=txt3, outputs=html1,queue=False).then(self.get_cluster,txt3,html2)
    ...
    def get_cluster(self, user_likes):
    ...
    def get_predictions(self, user_likes, df=None):
